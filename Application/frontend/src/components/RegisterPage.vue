...
.floating-icon {
    ...
    animation-delay: 0s;
    /* Same as the title to float together */
}
...
.floating-text {
    ...
    animation: fadeIn 2s ease-in-out forwards;
    animation-delay: 1s;
    /* Staggered delay for floating text */
}
