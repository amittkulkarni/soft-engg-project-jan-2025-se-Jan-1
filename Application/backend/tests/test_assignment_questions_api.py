...
def test_get_assignment_question_by_id(client):
    ...
    response = client.get('/assignment_questions/1')  
...
def test_update_assignment_question_success(client):
    ...
    response = client.put('/assignment_questions/1', json=input_data) 
...
def test_delete_assignment_question_success(client):
    ...
    response = client.delete('/assignment_questions/1')  
    ...
    deleted_question = AssignmentQuestion.query.get(1)
