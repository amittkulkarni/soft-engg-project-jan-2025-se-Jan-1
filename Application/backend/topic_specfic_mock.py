...
MCQSet containing the generated questions
    ...
    mcq_prompt = ChatPromptTemplate.from_messages([
        (
            "system",
            """You are an expert Machine Learning instructor. Generate multiple choice questions
...
Generate challenging but fair questions that test conceptual understanding.
            Ensure all responses are in proper JSON format."""
        ),
        (
            "human",
